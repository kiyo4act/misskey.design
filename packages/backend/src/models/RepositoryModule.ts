...
const $chatDrawingsRepository: Provider = {
	provide: DI.chatDrawingsRepository,
	useFactory: (db: DataSource) => db.getRepository(MiChatDrawing).extend(miRepository as MiRepository<MiChatDrawing>),
	inject: [DI.db],
};
