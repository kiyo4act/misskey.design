...
export type ChatDrawingsCreateRequest = operations['chat___drawings___create']['requestBody']['content']['application/json'];
export type ChatDrawingsCreateResponse = operations['chat___drawings___create']['responses']['200']['content']['application/json'];
export type ChatDrawingsShowRequest = operations['chat___drawings___show']['requestBody']['content']['application/json'];
export type ChatDrawingsShowResponse = operations['chat___drawings___show']['responses']['200']['content']['application/json'];
export type ChatDrawingsUpdateRequest = operations['chat___drawings___update']['requestBody']['content']['application/json'];
export type ChatDrawingsUpdateResponse = operations['chat___drawings___update']['responses']['200']['content']['application/json'];
